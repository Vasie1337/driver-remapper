...
namespace imports
{
	...
	inline void* rtl_find_exported_routine_by_name(void* ImageBase, PCCH RoutineNam)
	{
	...
	//inline PKTHREAD ke_get_current_thread( )
	//{
	...
	//inline NTSTATUS zw_allocate_virtual_memory( HANDLE ProcessHandle, void** BaseAddress, ULONG_PTR ZeroBits, PSIZE_T RegionSize, ULONG AllocationType, ULONG Protect )
	//{
	...
	//inline NTSTATUS zw_query_virtual_memory( HANDLE ProcessHandle, void* BaseAddress, MEMORY_INFORMATION_CLASS MemoryInformationClass, void* MemoryInformation, SIZE_T MemoryInformationLength, PSIZE_T ReturnLength )
	//{
	...
	//inline NTSTATUS zw_free_virtual_memory( HANDLE ProcessHandle, void** BaseAddress, PSIZE_T RegionSize, ULONG FreeType )
	//{
